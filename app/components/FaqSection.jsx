        ...
        <section className="pt-12 pb-20 md:pt-16 md:pb-24 bg-white text-center">
            <div className="container mx-auto px-4 md:px-8">
                <div className="max-w-5xl mx-auto mb-12 md:mb-16">
                    <h2 className="text-3xl md:text-4xl font-semibold leading-tight font-montserrat mb-6" style={{ color: '#DD761C' }}>
                        Pertanyaan yang Sering Diajukan
                    </h2>
                    <p className="text-lg text-gray-600 leading-relaxed font-sans max-w-2xl mx-auto">
                        Temukan jawaban untuk pertanyaan umum tentang platform pelaporan infrastruktur GatotKota
                    </p>
                </div>
                ...
                <div className="mt-10 space-y-4 max-w-4xl mx-auto">
                    {faqData.map((item, index) => (
                        <div
                            ...
                            style={{ borderColor: openIndex === index ? '#DD761C' : '#e5e7eb' }}
                        >
                            <button
                            ...
                            >
                                ...
                                {openIndex === index ? (
                                    <ChevronDown className="w-5 h-5 md:w-6 md:h-6 flex-shrink-0 ml-4" style={{ color: '#DD761C' }} />
                                ) : (
